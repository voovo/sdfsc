...
public interface PortDao {
     ...
     * 
     */
    @Select("select ARCID,WKTRC,ADEP,ADES,ETA,ARCREG,SsrCode,STATUS,RTE,SECTOR from fdr where ADES='ZSJN' and ATA is not null and ATA >#{startTime, jdbcType=VARCHAR} and SECTOR not like 'AP%' order by ATA asc")
